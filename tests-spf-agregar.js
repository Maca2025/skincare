...
t('spf: pa4 + euuva no se suman',
  spfScoreOf({ tags: [{ cls: 'pa4' }, { cls: 'euuva' }] }), 55);

// — Magnitud sola.
t('spf: PA++++ solo', spfScoreOf({ tags: [{ cls: 'pa4' }] }), 55);
t('spf: PA+++ solo',  spfScoreOf({ tags: [{ cls: 'pa3' }] }), 40);
t('spf: PA++ solo',   spfScoreOf({ tags: [{ cls: 'pa2' }] }), 25);

// — Sin dato UVA: piso de amplio espectro, no cero.
t('spf: sin dato UVA', spfScoreOf({ tags: [] }), 20);
t('spf: tags cosméticos no puntúan',
  spfScoreOf({ tags: [{ cls: 'clear' }, { cls: 'best' }] }), 20);

// — Espectro: excluyente, se toma el mejor.
t('spf: UVA400 sobre PA++++',        spfScoreOf({ tags: [{ cls: 'pa4' }, { cls: 'uva400' }] }), 85);
t('spf: UVA largos sobre PA++++',    spfScoreOf({ tags: [{ cls: 'pa4' }, { cls: 'uvalong' }] }), 70);
t('spf: uva400 y uvalong no se suman',
  spfScoreOf({ tags: [{ cls: 'pa4' }, { cls: 'uva400' }, { cls: 'uvalong' }] }), 85);

// — Luz visible (óxidos de hierro).
t('spf: tintado suma 15', spfScoreOf({ tags: [{ cls: 'pa4' }, { cls: 'tinted' }] }), 70);
